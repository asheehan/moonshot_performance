defmodule MoonshotPerformanceWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MoonshotPerformanceWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MoonshotPerformanceWeb.Gettext, "errors", msg, opts)
    end
  end
